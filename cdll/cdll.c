...
static void
cdll_verify_head(cdll_head_t *head)
{
    if (!head)
    {
...
void *
cdll_node_data(cdll_node_t *node)
{
    return node->data;
}

void
cdll_node_destroy(cdll_node_t *node)
{
    node->prev = NULL;
    node->next = NULL;
    node->data = NULL;
...
void
cdll_insert_node(cdll_head_t *head, cdll_node_t *new_node)
{
    cdll_verify_head(head);
...
cdll_node_t *
cdll_remove_node(cdll_head_t *head, cdll_node_t *old_node)
{
    cdll_verify_head(head);
...
void
cdll_push_node(cdll_head_t *head, cdll_node_t *new_node)
{
    cdll_insert_node(head, new_node);
}

cdll_node_t *
cdll_pop_node(cdll_head_t *head)
{
    if (0 == head->entries)
    {
        return NULL;
...
void
cdll_enqueue_node(cdll_head_t *head, cdll_node_t *new_node)
{
    cdll_insert_node(head, new_node);
}

cdll_node_t *
cdll_dequeue_node(cdll_head_t *head)
{
    if (0 == head->entries)
    {
        return NULL;
